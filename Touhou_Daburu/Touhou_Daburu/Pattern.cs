...
namespace Touhou_Daburu
{
    class Pattern
    {
        ...
        public float mIndvArraySpread;
        public float mTotalArraySpread;
        public double mDirectionAngle;
        ...
        public void Fire(Enemy owner)
        {
            for (int i = 0; i < mArrayNumber; i++)
            {
                ...
                {
                    double angle = mDirectionAngle + mRotation + j*mIndvArraySpread + i*mTotalArraySpread;
                    ...
                    mGameBulletSpawnerPtr.SpawnBullet(mBulletType, mBulletColor, owner.GetPosition(), vel, acc, mHitBox, mDirectional);
                }
            }
        }
